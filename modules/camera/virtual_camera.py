...
class VirtualCamera:
    def __init__(self,
        ...
        # Load the pose
        self.pose_list = np.loadtxt(src_path + 'pose.txt', 
                                    delimiter=',')
        # Filter the pose
        self.pose_list = savgol_filter(self.pose_list, 
                                       window_length=10,
                                       polyorder=3,
                                       axis=0)
...
if __name__ == "__main__":
    ...
    # Run the camera
    camera = VirtualCamera(pose_address=pose_address, 
